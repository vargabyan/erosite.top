...
?><?$APPLICATION->IncludeComponent("bitrix:catalog", "catalog_subdomen", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_TYPE" => "girls",	// Тип инфоблока
		...
		"SEF_FOLDER" => "/salons/",	// Каталог ЧПУ (относительно корня сайта)
